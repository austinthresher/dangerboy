...
; each line when both OAM and VBLANK interrupts are enabled.
; Since the interrupt 40 VBLANK should take priority over the
; STAT VBLANK, this should never actually fire a STAT VBLANK.
...
print_loop:
   ...
   call print_newline
   print_string_literal "DONE. PASS IF"
   call print_newline
   print_string_literal "0, 2 to 90, 92"
   ret
