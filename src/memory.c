...
void mem_get_rom_info(void) {
  ...
  case 0x13:
    ...
    break;
  default:
    ERROR("Unknown banking mode: %X", mem_rom[0x0147]);
  }
  ...
  case 1:
  case 2:
    mem_ram_bank_count = 1;
    break;
  case 3:
    mem_ram_bank_count = 4;
    break;
  case 4:
    mem_ram_bank_count = 16;
    break;
  default:
    ERROR("Unknown RAM bank count: %X", mem_rom[0x0149]);
  }
