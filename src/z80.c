...
byte z80_get_flag_carry() { return (z80_F & z80_flag_carry) >> 4; }
byte z80_get_flag_halfcarry() { return (z80_F & z80_flag_halfcarry) >> 5; }
byte z80_get_flag_operation() { return (z80_F & z80_flag_operation) >> 6; }
byte z80_get_flag_zero() { return (z80_F & z80_flag_zero) >> 7; }
...
// LD r1, r2
void z80_LDA_A() { z80_LOAD(&z80_A, z80_A); }

void z80_LDA_B() { z80_LOAD(&z80_A, z80_B); }

void z80_LDA_C() { z80_LOAD(&z80_A, z80_C); }

void z80_LDA_D() { z80_LOAD(&z80_A, z80_D); }

void z80_LDA_E() { z80_LOAD(&z80_A, z80_E); }

void z80_LDA_H() { z80_LOAD(&z80_A, z80_H); }

void z80_LDA_L() { z80_LOAD(&z80_A, z80_L); }
...
void z80_LDB_A() { z80_LOAD(&z80_B, z80_A); }

void z80_LDB_B() { z80_LOAD(&z80_B, z80_B); }

void z80_LDB_C() { z80_LOAD(&z80_B, z80_C); }

void z80_LDB_D() { z80_LOAD(&z80_B, z80_D); }

void z80_LDB_E() { z80_LOAD(&z80_B, z80_E); }

void z80_LDB_H() { z80_LOAD(&z80_B, z80_H); }

void z80_LDB_L() { z80_LOAD(&z80_B, z80_L); }
...
void z80_LDC_A() { z80_LOAD(&z80_C, z80_A); }

void z80_LDC_B() { z80_LOAD(&z80_C, z80_B); }

void z80_LDC_C() { z80_LOAD(&z80_C, z80_C); }

void z80_LDC_D() { z80_LOAD(&z80_C, z80_D); }

void z80_LDC_E() { z80_LOAD(&z80_C, z80_E); }

void z80_LDC_H() { z80_LOAD(&z80_C, z80_H); }

void z80_LDC_L() { z80_LOAD(&z80_C, z80_L); }
...
void z80_LDD_A() { z80_LOAD(&z80_D, z80_A); }

void z80_LDD_B() { z80_LOAD(&z80_D, z80_B); }

void z80_LDD_C() { z80_LOAD(&z80_D, z80_C); }

void z80_LDD_D() { z80_LOAD(&z80_D, z80_D); }

void z80_LDD_E() { z80_LOAD(&z80_D, z80_E); }

void z80_LDD_H() { z80_LOAD(&z80_D, z80_H); }

void z80_LDD_L() { z80_LOAD(&z80_D, z80_L); }
...
void z80_LDE_A() { z80_LOAD(&z80_E, z80_A); }

void z80_LDE_B() { z80_LOAD(&z80_E, z80_B); }

void z80_LDE_C() { z80_LOAD(&z80_E, z80_C); }

void z80_LDE_D() { z80_LOAD(&z80_E, z80_D); }

void z80_LDE_E() { z80_LOAD(&z80_E, z80_E); }

void z80_LDE_H() { z80_LOAD(&z80_E, z80_H); }

void z80_LDE_L() { z80_LOAD(&z80_E, z80_L); }
...
void z80_LDH_A() { z80_LOAD(&z80_H, z80_A); }

void z80_LDH_B() { z80_LOAD(&z80_H, z80_B); }

void z80_LDH_C() { z80_LOAD(&z80_H, z80_C); }

void z80_LDH_D() { z80_LOAD(&z80_H, z80_D); }

void z80_LDH_E() { z80_LOAD(&z80_H, z80_E); }

void z80_LDH_H() { z80_LOAD(&z80_H, z80_H); }

void z80_LDH_L() { z80_LOAD(&z80_H, z80_L); }
...
void z80_LDL_A() { z80_LOAD(&z80_L, z80_A); }

void z80_LDL_B() { z80_LOAD(&z80_L, z80_B); }

void z80_LDL_C() { z80_LOAD(&z80_L, z80_C); }

void z80_LDL_D() { z80_LOAD(&z80_L, z80_D); }

void z80_LDL_E() { z80_LOAD(&z80_L, z80_E); }

void z80_LDL_H() { z80_LOAD(&z80_L, z80_H); }

void z80_LDL_L() { z80_LOAD(&z80_L, z80_L); }
...
void z80_LD_AT_HL_B() { z80_STORE(z80_H, z80_L, z80_B); }

void z80_LD_AT_HL_C() { z80_STORE(z80_H, z80_L, z80_C); }

void z80_LD_AT_HL_D() { z80_STORE(z80_H, z80_L, z80_D); }

void z80_LD_AT_HL_E() { z80_STORE(z80_H, z80_L, z80_E); }

void z80_LD_AT_HL_H() { z80_STORE(z80_H, z80_L, z80_H); }

void z80_LD_AT_HL_L() { z80_STORE(z80_H, z80_L, z80_L); }
...
void z80_LD_AT_BC_A() { z80_STORE(z80_B, z80_C, z80_A); }

void z80_LD_AT_DE_A() { z80_STORE(z80_D, z80_E, z80_A); }

void z80_LD_AT_HL_A() { z80_STORE(z80_H, z80_L, z80_A); }
...
void z80_LD_AT_C_A() { z80_STORE(0xFF, z80_C, z80_A); }
...
// PUSH
void z80_PUSHAF() { z80_PUSH(z80_A, z80_F); }

void z80_PUSHBC() { z80_PUSH(z80_B, z80_C); }

void z80_PUSHDE() { z80_PUSH(z80_D, z80_E); }

void z80_PUSHHL() { z80_PUSH(z80_H, z80_L); }

// POP
void z80_POPAF() { z80_POP(&z80_A, &z80_F); }

void z80_POPBC() { z80_POP(&z80_B, &z80_C); }

void z80_POPDE() { z80_POP(&z80_D, &z80_E); }

void z80_POPHL() { z80_POP(&z80_H, &z80_L); }
...
void z80_AND_A() { z80_AND(z80_A); }

void z80_AND_B() { z80_AND(z80_B); }

void z80_AND_C() { z80_AND(z80_C); }

void z80_AND_D() { z80_AND(z80_D); }

void z80_AND_E() { z80_AND(z80_E); }

void z80_AND_H() { z80_AND(z80_H); }

void z80_AND_L() { z80_AND(z80_L); }
...
void z80_OR_A() { z80_OR(z80_A); }

void z80_OR_B() { z80_OR(z80_B); }

void z80_OR_C() { z80_OR(z80_C); }

void z80_OR_D() { z80_OR(z80_D); }

void z80_OR_E() { z80_OR(z80_E); }

void z80_OR_H() { z80_OR(z80_H); }

void z80_OR_L() { z80_OR(z80_L); }
...
void z80_XOR_A() { z80_XOR(z80_A); }

void z80_XOR_B() { z80_XOR(z80_B); }

void z80_XOR_C() { z80_XOR(z80_C); }

void z80_XOR_D() { z80_XOR(z80_D); }

void z80_XOR_E() { z80_XOR(z80_E); }

void z80_XOR_H() { z80_XOR(z80_H); }

void z80_XOR_L() { z80_XOR(z80_L); }
...
void z80_CB() {
  ...
  byte *regs[] = {&z80_B, &z80_C, &z80_D, &z80_E, &z80_H, &z80_L, NULL, &z80_A};
...
void z80_ADD16_HL_BC() { z80_ADD16(&z80_H, &z80_L, z80_B, z80_C); }

void z80_ADD16_HL_DE() { z80_ADD16(&z80_H, &z80_L, z80_D, z80_E); }

void z80_ADD16_HL_HL() { z80_ADD16(&z80_H, &z80_L, z80_H, z80_L); }
...
void z80_INC16_BC() { z80_INC16(&z80_B, &z80_C); }

void z80_INC16_DE() { z80_INC16(&z80_D, &z80_E); }

void z80_INC16_HL() { z80_INC16(&z80_H, &z80_L); }
...
void z80_DEC16_BC() { z80_DEC16(&z80_B, &z80_C); }

void z80_DEC16_DE() { z80_DEC16(&z80_D, &z80_E); }

void z80_DEC16_HL() { z80_DEC16(&z80_H, &z80_L); }
...
void z80_ADD(byte inp) {
  int temp_result = z80_A; // This is used to figure out if z80_A will overflow,
...
void z80_ADD_A_A() { z80_ADD(z80_A); }

void z80_ADD_A_B() { z80_ADD(z80_B); }

void z80_ADD_A_C() { z80_ADD(z80_C); }

void z80_ADD_A_D() { z80_ADD(z80_D); }

void z80_ADD_A_E() { z80_ADD(z80_E); }

void z80_ADD_A_H() { z80_ADD(z80_H); }

void z80_ADD_A_L() { z80_ADD(z80_L); }
...
void z80_ADC_A_A() { z80_ADC(z80_A); }

void z80_ADC_A_B() { z80_ADC(z80_B); }

void z80_ADC_A_C() { z80_ADC(z80_C); }

void z80_ADC_A_D() { z80_ADC(z80_D); }

void z80_ADC_A_E() { z80_ADC(z80_E); }

void z80_ADC_A_H() { z80_ADC(z80_H); }

void z80_ADC_A_L() { z80_ADC(z80_L); }
...
void z80_SUB_A_A() { z80_SUB(z80_A); }

void z80_SUB_A_B() { z80_SUB(z80_B); }

void z80_SUB_A_C() { z80_SUB(z80_C); }

void z80_SUB_A_D() { z80_SUB(z80_D); }

void z80_SUB_A_E() { z80_SUB(z80_E); }

void z80_SUB_A_H() { z80_SUB(z80_H); }

void z80_SUB_A_L() { z80_SUB(z80_L); }
...
void z80_SBC_A_A() { z80_SBC(z80_A); }

void z80_SBC_A_B() { z80_SBC(z80_B); }

void z80_SBC_A_C() { z80_SBC(z80_C); }

void z80_SBC_A_D() { z80_SBC(z80_D); }

void z80_SBC_A_E() { z80_SBC(z80_E); }

void z80_SBC_A_H() { z80_SBC(z80_H); }

void z80_SBC_A_L() { z80_SBC(z80_L); }
...
void z80_INC_A() { z80_INC(&z80_A); }

void z80_INC_B() { z80_INC(&z80_B); }

void z80_INC_C() { z80_INC(&z80_C); }

void z80_INC_D() { z80_INC(&z80_D); }

void z80_INC_E() { z80_INC(&z80_E); }

void z80_INC_H() { z80_INC(&z80_H); }

void z80_INC_L() { z80_INC(&z80_L); }
...
void z80_DEC_A() { z80_DEC(&z80_A); }

void z80_DEC_B() { z80_DEC(&z80_B); }

void z80_DEC_C() { z80_DEC(&z80_C); }

void z80_DEC_D() { z80_DEC(&z80_D); }

void z80_DEC_E() { z80_DEC(&z80_E); }

void z80_DEC_H() { z80_DEC(&z80_H); }

void z80_DEC_L() { z80_DEC(&z80_L); }
...
void z80_CP_A() { z80_COMPARE(z80_A); }

void z80_CP_B() { z80_COMPARE(z80_B); }

void z80_CP_C() { z80_COMPARE(z80_C); }

void z80_CP_D() { z80_COMPARE(z80_D); }

void z80_CP_E() { z80_COMPARE(z80_E); }

void z80_CP_H() { z80_COMPARE(z80_H); }

void z80_CP_L() { z80_COMPARE(z80_L); }
